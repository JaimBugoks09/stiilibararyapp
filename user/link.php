...
<button id="categ" name="categ" style="background: none; border: none"><h5 id="categ"><i class="fa fa-bars"></i></h5></button>
<ul>
    ...
    <li><a href="./account.php" id="btn_reserved" class="btn"><i class="fa fa-user"></i> </a></li>
